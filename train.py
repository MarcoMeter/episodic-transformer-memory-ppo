import torch
from configs import carpole_config, cartpole_masked_config, minigrid_config, poc_memory_env_config
...
def main():
    ...
    trainer = PPOTrainer(carpole_config(), run_id=run_id, device=device)
